...
public class MysqlProxyServer {
    ...
    public static class MysqlProxyServerVerticle extends AbstractVerticle {
        private final int sourcePort = 3306;
        ...
        public void start() throws Exception {
            ...
            int targetPort = 3310;
            netServer.connectHandler(socket -> netClient.connect(sourcePort, mysqlHost, result -> {
    ...
    public static class MysqlProxyConnection {
        ...
        private void proxy() {
            ...
            clientSocket.handler(buffer -> {
                ...
                System.out.println(buffer.length() + " --> |" + buffer.toString(StandardCharsets.UTF_8) + "|");
                System.out.println(String.format("⬆################## client: %s ##################⬆", clientCount.get()));
